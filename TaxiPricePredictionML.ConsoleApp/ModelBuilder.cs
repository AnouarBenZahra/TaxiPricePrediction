...
using TaxiPricePredictionML.Model;

namespace TaxiPricePredictionML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\anoua\Desktop\taxi-fare-train.csv";
